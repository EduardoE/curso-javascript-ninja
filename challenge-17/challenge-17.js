(function() {
    ...
    */
    ...
    // ?
    console.log(text.replace(/Manuel Marques de Sousa/, 'Eduardo Nascimento'));
    /*
    ...
    */
    ...
    // ?
    console.log(text.replace(/brasileiro/, 'paraibano'));
    /*
    ...
    */
    ...
    // ?
    console.log(text.replace(/O Centauro de Luvas/g, function(prase) {
        return prase.toUpperCase();
    }) );
