...
*/
var pessoa = {nome: 'Eduardo', sobrenome: 'Nascimento', sexo: 'Masculino', idade: 25, altura: 1.70, peso: 57.6, andando: false, caminhouQuantosMetros: 0};
...
*/
pessoa.nomeCompleto(); // "Olá! Meu nome é Eduardo Nascimento"
...
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarPeso(); //"Eu peso 57.6 Kg."
...
*/
pessoa.caminhouQuantosMetros; // 43.5
...
"Olá, eu sou a Eduardo Nascimento, tenho 28 anos, Minha altura é 1.7 m., Eu peso 57.6 Kg. E só hoje caminhei 43.5 metros."
