(function() {
    ...
    */
    ...
    // =====> outra forma de resolver, utilizando função.  <========
    // cpfs.forEach(function(cpf) {
    ...
    */
    ...
    console.log(html2.match(regex3));
    /*
    ...
    */
    ...
    // ?
    var regex4 = /<(\w+)>([^<]+)<\/\w+>/g;
    var html3 = "<h1>Título da página</h1><p>Este é um parágrafo</p><footer>Rodapé</footer>";

    console.log(html3.replace(regex4, '<$1>O texto dentro da tag "$1" é "$2"</$1>\n'
    ));
}) ();