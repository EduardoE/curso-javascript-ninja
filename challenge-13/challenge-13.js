(function() {    
    ...
    */
    var sul = ['Minas Gerais', 'Rio de Janeiro', 'São Paulo', 'Espírito Santo'];
    var sudeste = ['Paraná', 'Rio Grande do Sul', 'Santa Catarina'];
    ...
    */
    ...
    brasil.unshift('Amazomas', 'Pará', 'Amapá');
    ...
    */
    // ?
    var nordeste = ['Paraíba', 'Pernambuco', 'Rio Grande do Norte', 'Alagoas', 'Ceará', 'Piauí', 'Bahia', 'Maranhão', 'Sergipe'];
    /*
